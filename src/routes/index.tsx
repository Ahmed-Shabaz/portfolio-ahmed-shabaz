...
const projects = [
  {
    number: "01",
    title: "Web Scraping & Data Extraction Platform",
    description: "Scalable scraping framework for 100+ websites using Selenium, BeautifulSoup, and headless browsers with CAPTCHA handling, rate limiting, and anti-bot protection.",
    tools: ["Python", "Selenium", "BeautifulSoup", "Pandas", "Headless Browsers"],
    impact: "70% manual effort reduction",
  },
  {
    number: "02",
    title: "Bulk File Download Automation",
    description: "Automated batch download system that handles authentication, retries, resume logic, and directory organization for large-scale file acquisition workflows.",
    tools: ["Python", "Requests", "Multithreading", "File I/O", "Logging"],
    impact: "80% faster file retrieval",
  },
  {
    number: "03",
